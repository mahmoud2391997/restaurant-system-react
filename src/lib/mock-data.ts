...
export const mockTables: Table[] = [
  { id: "TBL-001", number: 1, zone: "Main Dining" },
  { id: "TBL-002", number: 2, zone: "Main Dining" },
  { id: "TBL-003", number: 3, zone: "Main Dining" },
  { id: "TBL-004", number: 4, zone: "Main Dining" },
  { id: "TBL-005", number: 5, zone: "Patio" },
  { id: "TBL-006", number: 6, zone: "Patio" },
  { id: "TBL-007", number: 7, zone: "VIP" },
  { id: "TBL-008", number: 8, zone: "VIP" },
  { id: "TBL-009", number: 9, zone: "Bar" },
  { id: "TBL-010", number: 10, zone: "Bar" },
]
...
export const getTablesByZone = (zone: string): Table[] => {
  return mockTables.filter((table) => table.zone === zone)
}
